...
<br><br><br><br><br><br><br><br><br><br><br>
	...
	<div class="main">
		...
		<table>
			...
			<tr >	
				<td class="box" style="text-align: left;">
					...
					AP.4 엔터테인먼트는 창의적인 마인드와 끊임없는 열정을 바탕으로 엔터테인먼트 사업의 선진화와 가치 확보를 위해 노력하고 있습니다.<br>
					현실에 안주하지 않고 끊임없이 전진하는 전문가 아티스트가 스타쉽을 더욱 더 빛나게 하는 요소가 된다고 생각합니다.<br><br>
					컨텐츠가 가지는 본질적인 가치와 감동, 아티스트 발굴 및 육성 그에 맞는 아이템 상품, 매니지먼트 등 다양한 비즈니스 모델로 엔터테인먼트의 미래를 선도해 나가겠습니다.
				</td>
			</tr>
		</table>
		<br><br><br><br><br><br>
		...
		<table>
			...
			<tr >	
				<td class="box" style="text-align: left;">
					<br>저희는 소속 아티스트들의 매니지먼트와 에이전트, 기본적인 엔터테인먼트 비즈니스 모델에 기초해<br>
